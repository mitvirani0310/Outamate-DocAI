        ...
        <div className="w-full md:w-1/2 bg-white  p-6 md:py-8 md:px-10 flex flex-col">
          <div className="flex-grow w-full max-w-md mx-auto space-y-4">
            ...
            <div className="flex justify-center mb-2">
              <img src={OutamationLogo} alt="Outamation Logo" className="h-20" />
            </div>
            
            {/* Heading */}
            <h1 className="text-xl font-bold text-center text-gray-800">Welcome to Document AI</h1>
            
            {/* Login text */}
            <p className="text-base text-center text-gray-600 mb-2">Login to your account</p>
          ...
          {/* Footer links */}
          <div className="flex justify-between text-sm gap-2 text-gray-500 pt-6 pb-2 max-w-md mx-auto">
          ...
          {/* Copyright */}
          <p className="text-xs text-center text-gray-500 max-w-md mx-auto pb-2">
